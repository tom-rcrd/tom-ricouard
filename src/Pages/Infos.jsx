  ...
  return (  
    <>  
      ...
      <div className="hero-infos">  
          ...
          <div className="container-infos">  
            <div className="infos-left">  
              <div className="description-infos">  
                <h1>[FR]</h1>  
                <p>  
                  Designer graphique multifonctions basé au Havre, je me spécialise dans le design numérique et imprimé : éditions, identités visuelles, web design, supports print ou communication numérique.  
                  J’expérimente également autour de la vidéo et de la photographie. J’essaie d’aborder la création comme une science en plaçant la recherche et l’expérimentation au cœur de mon travail. Passionné par la technique, je croise souvent les pratiques afin de créer des images uniques et percutantes.  
                </p>  
              </div>  
              <div className="description-infos">  
                <h1>[EN]</h1>  
                <p>  
                  Multifunctional graphic designer based in Le Havre, I specialize in both digital and print design: publishing, visual identities, web design, print materials, and digital communication.  
                  I also experiment with video and photography. I approach creation like a science, placing research and experimentation at the heart of my work. Passionate about technique, I often blend practices to create unique and impactful visuals.  
                </p>  
              </div>  
              ...
              <p className="align-right">  
                ...
                <br />
                If you're interested in working together or have any other inquiries, contact me  
              </p>  
              <p className="adress">  
        ...
        <div className="container-infos-right">
